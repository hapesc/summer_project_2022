...
public class MergeSort3Way
{
    ...
    public static void mergeSort3Way(String[] gArray)
    {
    ...
    public static void mergeSort3WayRec(String[] gArray,
                                        int low, int high, String[] destArray)
    {
    ...
    public static void merge(String[] gArray, int low,
